                    ...
                    DbContextOptions<HomeFinderContext>>()))
            {
                ...
                context.PropertyObjects.AddRange(
                    new PropertyObject
                    {
                        ...
                        Images = { new HomeFinderImages { AltText = "Utan möbler", Path = "~/Images/lichtraum-1560788_960_720.webp" }, new HomeFinderImages { AltText = "Miljö utanför", Path = "~/Images/modern-buildings-3480351_960_720.jpg" } },
                        LeaseType = leaseType,
                        ListPrice = 100000,
                        LotArea = 0,
                    ...
                    new PropertyObject
                    {
                        ...
                        Images = { new HomeFinderImages { AltText = "Vardagsrum", Path = "~/Images/dining-room-3108037_960_720.webp" }, new HomeFinderImages { AltText = "Badrum", Path = "~/Images/modern-minimalist-bathroom-3115450_960_720.jpg" } },
                        LeaseType = leaseType,
                        ListPrice = 300000,
                        LotArea = 0,
                        NextShowingDateTime = DateTime.Now.Date,
